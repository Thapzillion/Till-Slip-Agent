...
export default function AgentParameters({ selectedTemplateId, setSelectedTemplateId, receipt, setReceipt }) {

  const [currentTemplate, setCurrentTemplate] = useState(
    selectedTemplateId || localStorage.getItem("ruachagent:selectedTillSlipDesign") || "matrix-grid"
  );

  // Keep synced if user changes it in TillSlipsCollection
  useEffect(() => {
    if (selectedTemplateId) {
      setCurrentTemplate(selectedTemplateId);
    }
  }, [selectedTemplateId]);
  ...
  useEffect(() => {
    ...
    window.addEventListener("ruachagent:tillSlipDesignSelected", handleDesignChange);
    return () => window.removeEventListener("ruachagent:tillSlipDesignSelected", handleDesignChange);
  }, []);
  ...
  const styles = {
    ...
    gridOverlay: {
      ...
      backgroundImage: `
      linear-gradient(
        rgba(80, 255, 255, 0.04) 1px,
        transparent 1px
      ),
      linear-gradient(
        90deg,
        rgba(80, 249, 255, 0.04) 1px,
        transparent 1px
      )
    `,
    ...
    statusPill: {
      ...
      padding: '8px 12px',
      borderRadius: '999px',
      border: '1px solid rgba(0, 251, 255, 0.44)',
    ...
    `,
      border: '1px solid rgba(5, 149, 156, 0.24)',
      boxShadow: `
    ...
    cardIcon: {
      ...
      alignItems: 'center',
      justifyContent: 'center',
      background: 'rgba(0, 193, 227, 0.1)',
      border: '1px solid rgba(62, 245, 255, 0.42)',
      color: '#68dcff',
      fontSize: '12px',
      boxShadow: '0 0 18px rgba(0, 217, 255, 0.39)',
    },
    ...
    input: {
      ...
      borderRadius: '9px',
      outline: 'none',
      border: '1px solid rgba(73, 133, 134, 0.28)',
    ...
    textarea: {
      ...
      outline: 'none',
      resize: 'vertical',
      border: '1px solid rgba(0, 221, 255, 0.36)',
    ...
    select: {
      ...
      borderRadius: '9px',
      outline: 'none',
      border: '1px solid rgba(73, 130, 134, 0.28)',
      background: '#070b10',
      color: '#eaf1f8',
      fontSize: '11px',
    ...
    uploadZone: {
      ...
      minHeight: '145px',
      borderRadius: '13px',
      border: '1px dashed rgba(64, 245, 255, 0.44)',
      background: `
      radial-gradient(
        circle at 50% 0%,
        rgba(0, 234, 255, 0.08),
    ...
    uploadIcon: {
      ...
      justifyContent: 'center',
      color: '#65fffca9',
      background: 'rgba(0, 155, 152, 0.15)',
      border: '1px solid rgba(68, 249, 255, 0.25)',
      fontSize: '17px',
    },
    ...
    logoPreview: {
      minHeight: '145px',
      borderRadius: '13px',
      border: '1px solid rgba(72, 125, 132, 0.24)',
      background: `
      radial-gradient(
        circle,
