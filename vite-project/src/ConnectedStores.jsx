    ...
    return (
        ...
        <div className="min-h-screen bg-[#050505] text-white">
            ...
            <div className="fixed inset-0 overflow-hidden pointer-events-none">
                ...
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,#1b1b1b_0%,#050505_45%,#000_100%)]" />

                <div className="absolute -top-72 left-1/2 h-[650px] w-[650px] -translate-x-1/2 rounded-full bg-white/5 blur-[170px]" />

                <div className="absolute bottom-0 left-0 h-[300px] w-[300px] rounded-full bg-cyan-500/5 blur-[150px]" />

                <div className="absolute right-0 top-1/3 h-[350px] w-[350px] rounded-full bg-white/5 blur-[180px]" />
