...
// Minimal style tokens used across this component tree
const styles = {
  page: { padding: 24 },
  backgroundGlowOne: { position: 'absolute' },
  backgroundGlowTwo: { position: 'absolute' },
  headerCard: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 16, padding: 20 },
  headerLeft: {},
  pageEyebrow: { fontSize: 12, color: '#9ca3af', marginBottom: 6 },
  pageTitle: { fontSize: 28, margin: 0 },
  pageSubtitle: { color: '#9ca3af', marginTop: 6 },
  headerRight: {},
  liveChip: { display: 'flex', alignItems: 'center', gap: 8, background: '#0b1220', padding: '6px 10px', borderRadius: 999 },
  liveDot: { width: 10, height: 10, borderRadius: 999, background: '#10b981', display: 'inline-block' },
  statusBar: { display: 'flex', gap: 12, marginTop: 18, marginBottom: 18 },
  statusPill: { padding: '10px 14px', background: '#071018', borderRadius: 10, display: 'flex', gap: 12, alignItems: 'center' },
  statusLabel: { fontSize: 12, color: '#9ca3af' },
  statusValue: { fontWeight: 700 },
  dashboardGrid: { display: 'grid', gridTemplateColumns: '1fr 360px', gap: 20, marginTop: 18 },
  mainColumn: {},
  metricsGrid: { display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 12 },
  metricCard: { padding: 16, borderRadius: 12, background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.04)' },
  metricHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center' },
  metricTitle: { fontSize: 13, color: '#9ca3af' },
  metricBadge: { fontSize: 12, padding: '4px 8px', borderRadius: 8, background: 'transparent' },
  metricValue: { fontSize: 24, fontWeight: 700, marginTop: 8 },
  metricFooter: { marginTop: 10, color: '#9ca3af', fontSize: 13 },
  analyticsGrid: { display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 12 },
  glassPanel: { padding: 16, borderRadius: 12, background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.03)' },
  panelHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  panelTitle: { fontWeight: 700 },
  panelBadge: { fontSize: 12, color: '#9ca3af' },
  panelBody: {},
  sectionTitle: { fontSize: 16, fontWeight: 700, margin: '18px 0' },
  timelineChart: { display: 'flex', gap: 6, alignItems: 'flex-end', padding: '12px 0' },
  timelineBarWrapper: { flex: 1, display: 'flex', alignItems: 'flex-end' },
  timelineBar: { width: '100%', borderRadius: 6 },
  chartGridOne: {},
  chartGridTwo: {},
  chartGridThree: {},
  healthWidgetNumber: { fontSize: 28, fontWeight: 700 },
  progressTrack: { height: 10, background: '#0b0d11', borderRadius: 8, marginTop: 12 },
  progressFill: { height: '100%', borderRadius: 8 },
  widgetDescription: { marginTop: 8, color: '#9ca3af' },
  snapshotGrid: { display: 'grid', gap: 8 },
  snapshotRow: { display: 'flex', justifyContent: 'space-between', padding: '8px 0' },
  performanceGrid: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 },
  performanceCard: { padding: 12 },
  performanceHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center' },
  performanceTitle: { fontWeight: 700 },
  performanceChip: { background: '#0b1220', padding: '4px 8px', borderRadius: 8 },
  performanceValue: { fontSize: 20, fontWeight: 700 },
  performanceDescription: { marginTop: 8, color: '#9ca3af' },
  ...
  summarySubtitle: { color: '#9ca3af' },
  summaryStatus: { fontWeight: 700 },
  summaryGrid: { display: 'grid', gridTemplateColumns: 'repeat(2,1fr)', gap: 8 },
  summaryItem: { padding: 8 },
  summaryLabel: { color: '#9ca3af' },
  summaryValue: { fontWeight: 700 },
  healthScoreWrapper: { display: 'flex', justifyContent: 'center', alignItems: 'center', padding: 12 },
  healthRing: { width: 120, height: 120, borderRadius: 999, background: '#071018', display: 'flex', alignItems: 'center', justifyContent: 'center' },
  healthRingInner: { textAlign: 'center' },
  healthScoreValue: { fontSize: 22, fontWeight: 800 },
  healthScoreLabel: { fontSize: 12, color: '#9ca3af' },
  healthList: {},
  healthRow: { display: 'flex', justifyContent: 'space-between', padding: '8px 0' },
  systemGrid: { display: 'grid', gap: 8 },
  systemCard: { display: 'flex', gap: 12, alignItems: 'center' },
  systemDot: { width: 12, height: 12, borderRadius: 999 },
  systemTitle: { fontWeight: 700 },
  systemSubtitle: { color: '#9ca3af' },
  insightCard: { padding: 12 },
  insightTitle: { fontWeight: 700 },
  insightBigNumber: { fontSize: 24, fontWeight: 800 },
  aiInsightsList: { marginTop: 12 },
  aiInsightRow: { display: 'flex', justifyContent: 'space-between', padding: '6px 0' },
  aiRecommendationBox: { marginTop: 12, padding: 12, background: '#071018', borderRadius: 8 },
  aiRecommendationTitle: { fontWeight: 700 },
  aiRecommendationText: { color: '#9ca3af' }
};
